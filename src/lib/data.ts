...
import { Box, Wind, Gem, Circle } from 'lucide-react';
...
export const initialProducts: Product[] = [
  ...
  { id: 'coconut', name: 'Coconut', quantity: 0, costPrice: 10, sellingPrice: 15, icon: Circle },
  { id: 'copra', name: 'Copra', quantity: 0, costPrice: 30, sellingPrice: 45, icon: Circle },
];
