...
const prompt = ai.definePrompt({
  ...
  prompt: `
    ...
    Here is the data context you must analyze:
    ---
    {{{input}}}
    ---

    Analyze the provided data to fulfill the "Report Request" specified in the context.
    ...
    Do not just list the data. Provide insights and analysis based on the transactions.
